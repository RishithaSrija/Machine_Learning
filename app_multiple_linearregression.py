...
<div class="card">
            ...
            <p>Predict <b>Tip amount </b> based on <b> Total bill</b> using Multiple Linear Regression... </p>
...
st.markdown(f""" 
        ...
        <p><b>Total Bill Co-efficient:</b> {model.coef_[0]:.3f}<br>
        <b>Size Co-efficient:</b> {model.coef_[1]:.3f}<br>
